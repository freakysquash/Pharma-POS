<?php
    ...
    if(isset($_GET["s"])){
        $d = viewCompletedTotalAmountsByDateRange($_GET["s"], $_GET["e"]);
    }
?>
...
<div class="report-generated">
    <div class="report-header">
        <span class="report-title">Date Range Sales</span>
        <span class="report-date">Date: <?php echo date("F d, Y", strtotime($_GET["s"])) . " to " . date("F d, Y", strtotime($_GET["e"])); ?></span>
    </div>
    <div class="report-content">
        <table>
            ...
            <tbody>
                <?php
                    $sales = viewCompletedTransactionItemsByDateRange($_GET["s"], $_GET["e"]); 
